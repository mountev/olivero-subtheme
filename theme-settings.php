...
/**
 * @file
 * Functions to support ios theme settings.
 */
 ...
 */
function ios_form_system_theme_settings_alter(&$form, FormStateInterface $form_state) {
  $form['ios_settings']['ios_utilities'] = [
    '#type' => 'fieldset',
    '#title' => t('ios Utilities'),
  ];
  $form['ios_settings']['ios_utilities']['mobile_menu_all_widths'] = [
    '#type' => 'checkbox',
  ...
  $form['ios_settings']['ios_utilities']['site_branding_bg_color'] = [
    '#type' => 'select',
