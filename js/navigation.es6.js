...
((Drupal, once, tabbable) => {
  ...
  function init(props) {
    ...
    document.addEventListener('keyup', (e) => {
      if (e.key === 'Escape' || e.key === 'Esc') {
        if (props.ios.areAnySubNavsOpen()) {
          props.ios.closeAllSubNav();
        } else {
   ...
   */
  Drupal.behaviors.iosNavigation = {
    attach(context) {
