...
((Drupal) => {
  ...
  Drupal.ios.toggleSubNav = toggleSubNav;
  ...
  function handleBlur(e) {
    if (!Drupal.ios.isDesktopNav()) return;
  ...
  Drupal.ios.closeAllSubNav = closeAllSubNav;
  ...
  Drupal.ios.areAnySubNavsOpen = areAnySubNavsOpen;
